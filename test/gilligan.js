  ...
  describe('/api/v1/deployment', () => {
    it('it should create a deployment - specific location', (done) => {
      ...
      .end((err, res) => {
        ...
        res.body.kubercjson.spec.template.spec.containers[0].volumeMounts.should.containDeep([ { name: 'config-volume-0', mountPath: '/data' }, { name: 'empty', mountPath: '/mydirectory' }, { name: 'secret-volume', mountPath: '/mysecrets' } ]);
